...
export function IntroduccionStep({
  onNext,
  onPrevious,
}: IntroduccionStepProps) {
  ...
  const { control, handleSubmit, getValues } = useForm<IntroduccionForm>({
    defaultValues: useModeloNegocioWizardStore.getState().formData.introduccion,
  })
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field data-invalid={fieldState.invalid}>
            <FieldLabel htmlFor={field.name}>Reseña introductoria *</FieldLabel>
