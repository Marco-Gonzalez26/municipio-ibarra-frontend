...
export function FichaStep({ contexto, onNext }: FichaStepProps) {
  const updateFicha = useModeloNegocioWizardStore((state) => state.updateFicha)
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid}>
              ...
              <Input {...field} id={field.name} placeholder="ATPE-00071-2025" />
