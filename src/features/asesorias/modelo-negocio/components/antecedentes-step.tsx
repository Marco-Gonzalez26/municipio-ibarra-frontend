...
export const AntecedentesStep = forwardRef<StepHandle, AntecedentesStepProps>(
  function AntecedentesStep({ onNext, onPrevious }, ref) {
    ...
    const { control, handleSubmit, getValues } = useForm<AntecedentesForm>({
      defaultValues:
        useModeloNegocioWizardStore.getState().formData.antecedentes,
    })

    useImperativeHandle(ref, () => ({
      saveDraft: () => updateAntecedentes(getValues()),
    }))
